import { FileText, Ruler, Factory, Truck, HardHat, CheckCircle } from "lucide-react";
...
const stages = [
  {
    ...
    description: "Обсуждаем ваши требования, бюджет и сроки. Бесплатный выезд инженера на объект.",
    duration: "1–2 дня",
  },
  {
    icon: Ruler,
    ...
    description: "Разрабатываем проект с учётом нагрузок, климата и назначения здания.",
    duration: "5–10 дней",
  },
  {
    icon: Factory,
    number: "03",
    title: "Производство",
    description: "Изготавливаем металлоконструкции и сэндвич-панели на собственном заводе.",
    duration: "2–3 недели",
  },
  {
    icon: Truck,
    number: "04",
    title: "Доставка",
    description: "Логистика комплектующих на объект по всему Приволжскому округу.",
    duration: "1–3 дня",
  },
  {
    icon: HardHat,
    number: "05",
    title: "Монтаж",
    description: "Профессиональная бригада выполняет сборку здания под ключ.",
    duration: "2–4 недели",
  },
  {
    icon: CheckCircle,
    number: "06",
    title: "Сдача объекта",
    description: "Подписание акта, передача документации и гарантийное обслуживание.",
    duration: "1 день",
  },
];
