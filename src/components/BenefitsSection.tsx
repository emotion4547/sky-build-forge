import { Clock, Maximize, Award, Shield, Wrench, Truck } from "lucide-react";

const benefits = [
  {
    icon: Clock,
    title: "Сроки от 6 недель",
    description: "Быстрое проектирование и возведение благодаря готовым конструктивным решениям",
  },
  {
    icon: Maximize,
    title: "Пролёты до 60 м",
    description: "Большие пролёты без промежуточных опор для максимальной полезной площади",
  },
  {
    icon: Award,
    title: "Сертификация СРО",
    description: "Все необходимые лицензии на проектирование и строительство",
  },
  {
    icon: Shield,
    title: "Гарантия 5 лет",
    description: "Полная гарантия на конструкции и выполненные работы",
  },
  {
    icon: Wrench,
    title: "Своё производство",
    description: "Собственный завод металлоконструкций — контроль качества на всех этапах",
  },
  {
    icon: Truck,
    title: "Доставка по ПФО",
    description: "Логистика по всем регионам Приволжского федерального округа",
  },
];
